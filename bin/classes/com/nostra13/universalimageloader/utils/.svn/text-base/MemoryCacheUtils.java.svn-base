...
public final class MemoryCacheUtils {
	 ...
	 */
	public static List<Bitmap> findCachedBitmapsForImageUri(String imageUri, MemoryCache<String,Bitmap> memoryCache) {
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain ImageLoaderConfiguration configuration}
	 */
	public static List<String> findCacheKeysForImageUri(String imageUri, MemoryCache<String,Bitmap> memoryCache) {
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain ImageLoaderConfiguration configuration}
	 */
	public static void removeFromCache(String imageUri, MemoryCache<String,Bitmap> memoryCache) {
