 ...
 * @since 1.0.0
 */
public class FuzzyKeyMemoryCache implements MemoryCache<String, Bitmap> {

	private final MemoryCache<String, Bitmap> cache;
	private final Comparator<String> keyComparator;

	public FuzzyKeyMemoryCache(MemoryCache<String, Bitmap> cache, Comparator<String> keyComparator) {
		this.cache = cache;
